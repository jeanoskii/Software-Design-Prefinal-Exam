...
<html>
    ...
    <body>
        ...
        <div class="section center">
            ...
            <p>Happiness gives people strength to live their life to the fullest</p>
        </div>
        <div class="section center alternate">
            <img class="circular frame"  src="images/pogi.png"/>
            <h2>Oyson, John Reinier</h2>
            <p>Smile is the most precious thing in life</p>
        </div>

        <!-- sample section with inline CSS -->
        <div class="section center alternate" style="background-color:indigo">
            <img class="circular frame" src="images/pogi.png"/>
            <h2 style="color:white">Oyson, John Reinier</h2>
            <p style="color:white">The purpose of living is to gain memories that we will cherish forever.</p>
        </div>
